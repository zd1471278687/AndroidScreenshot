...
import app.zd.androidscreenshot.adapter.delegate.ItemViewDelegate;
import app.zd.androidscreenshot.adapter.delegate.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends BaseAdapter {
    ...
    public T getItem(int position) {
        if (mDatas == null || position < 0 || position >= getCount()) {
            return null;
        }
